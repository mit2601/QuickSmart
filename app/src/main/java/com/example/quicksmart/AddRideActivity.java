...
public class AddRideActivity extends AppCompatActivity {
    ...
    private void createRide() {
        ...
        try {
            ...
            // Get driver details from SharedPreferences (using ConstantSp if available)
            ...
            ride.put("rideId", rideId); // Include rideId in the data
            ...
            // FIX: Use rideref.set(ride) instead of dbRef.child().setValue()
